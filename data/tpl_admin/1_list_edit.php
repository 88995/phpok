...
<div class="main2">
	...
	<div class="pfw mb10">
		...
		<?php } ?>
		<tr>
			<td align="right" width="100"><?php echo P_Lang("计量单位：");?></td>
			<td><input type="text" id="unit" name="unit" class="short" value="<?php echo $rs['unit'];?>" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo P_Lang("产品类型：");?></td>
			<td>
				<ul class="layout">
					<li><label><input type="radio" name="is_virtual" value="0"<?php if(!$rs['is_virtual']){ ?> checked<?php } ?> />实物</label></li>
					<li><label><input type="radio" name="is_virtual" value="1"<?php if($rs['is_virtual']){ ?> checked<?php } ?> />虚拟/服务</label></li>
				</ul>
				<div class="clear"></div>
			</td>
		</tr>
		<tr>
			<td align="right"><?php echo P_Lang("货币：");?></td>
			<td>
		...
		<tr>
			<td align="right"><?php echo P_Lang("销售价格：");?></td>
			<td><input type="text" id="price" name="price" value="<?php echo $rs['price'];?>" style="width:80%" /></td>
		</tr>
		</table></div>
	</div>
	<?php } ?>
	...
	<div class="pfw mb10">
		...
		<table width="100%">
		<tr>
			<td align="right" width="90"><?php echo P_Lang("状态：");?></td>
			<td>
				<ul class="layout">
		...
		<tr>
			...
			<td><input type="text" id="dateline" name="dateline" class="default" value="<?php if($rs['dateline']){ ?><?php echo date('Y-m-d H:i:s',$rs['dateline']);?><?php } else { ?><?php echo date('Y-m-d H:i:s',$sys['time']);?><?php } ?>" onfocus="show_dateline()" style="width:180px" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo P_Lang("阅读次数：");?></td>
			<td><input type="text" id="hits" name="hits" class="short" value="<?php echo $rs['hits'];?>" /></td>
		</tr>
		<tr>
			<td align="right"><?php echo P_Lang("财富基数：");?></td>
			<td><input type="text" id="integral" name="integral" class="short" value="<?php echo $rs['integral'];?>" /> <span class="gray"><?php echo P_Lang("（只支持整数）");?></span></td>
		</tr>
		<tr>
...
<div class="clear"></div>
<div class="submit-info"><input type="submit" value="<?php echo P_Lang("提交");?>" class="submit2" id="phpok_submit_<?php echo $pid;?>" /></div>
</form>
<script type="text/javascript">
function win_resize()
{
